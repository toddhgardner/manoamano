	...
	if (iPadiPhone) {
              ...
              bounds_changed: function(){
                ...
                jQuery(this).gmap3({
                  ...
                  callback: function (){
                    ...
                    ?>
                                   myData_array[] = [{'lat' : <?php echo $data[ 'latitude' ]; ?>, 'lng' : <?php echo $data[ 'longitude' ]; ?>, data:{'title' : "<?php the_title(); ?>", 'address' : "<?php echo $data[ 'address_one' ]; ?>"}}];<?php endwhile; else:?>
                    alert('You need to add posts to display on the map.');
                    <?php endif;
                    ?>//This php calls out and places the data on the front page footer- 'KEY' = PostMETA 'Meta_KEY' in SQL DB
                  }
                });
              }
            }
        ...
        function add(jQuerythis, i, title, link, excerpt, lati, longi, img, pin){
          jQuerythis.gmap3({
            action : 'addMarker',
            radius: 50,
            markers: myData_array,//* I don't know what to do after this...
            lat:lati,
            lng:longi,
