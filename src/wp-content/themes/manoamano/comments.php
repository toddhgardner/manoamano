...
// Do not delete these lines
	...
	if ( post_password_required() ) { ?>
		<p class="nocomments"><?php _e("This post is password protected. Enter the password to view comments.", 'organicthemes'); ?></p>
	<?php
		return;
	}
?>
...
<!-- You can start editing here. -->
	...
	<h4><?php _e("Trackbacks", 'organicthemes'); ?></h4>
...
<h4><?php _e("Leave A Comment", 'organicthemes'); ?></h4>
...
<p><?php _e("You must be", 'organicthemes'); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>"><?php _e("logged in", 'organicthemes'); ?></a> <?php _e("to post a comment.", 'organicthemes'); ?></p></div>
<?php else : ?>
